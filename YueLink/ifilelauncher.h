...
public:
     ...
     */
    [[nodiscard]] virtual bool openFile(const QString &filePath, QString *errorMessage) = 0;
    /**
     * @brief 在系统文件管理器中定位文件。
     ...
     */
    [[nodiscard]] virtual bool revealInFolder(const QString &filePath, QString *errorMessage) = 0;
};
